...
def main():
    ...
    start = time.perf_counter()
    auth_result_ab, session_key_ab = ecdh_handshake(alice, bob)
    auth_result_bc, session_key_bc = ecdh_handshake(bob, cathy)
    auth_result_ac, session_key_ac = ecdh_handshake(alice,cathy)
