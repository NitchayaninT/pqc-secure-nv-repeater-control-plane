...
def main():
    ...
    start = time.perf_counter()
    auth_result_ab, session_key_ab = rsa_handshake(alice, bob)
    auth_result_bc, session_key_bc = rsa_handshake(bob, cathy)
    auth_result_ac, session_key_ac = rsa_handshake(alice,cathy) 
